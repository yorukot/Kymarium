...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/team_invite.createTeamInviteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/teams/{teamID}/invites/{inviteID}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid team or invite ID",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/team_invite.updateInviteRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "team_invite.createTeamInviteRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "team_invite.updateInviteRequest": {
            "type": "object",
            "required": [
                "status"
            ],
